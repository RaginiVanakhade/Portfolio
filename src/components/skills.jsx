...
const Skills = () => {
  ...
  return (
    <div className="relative flex flex-col-reverse md:flex-row items-center justify-between mt-16 gap-10 px-4 md:px-16">
      {/* Skills Section */}
      ...
      <div className="absolute w-60 h-60 bg-blue-300 rounded-full opacity-40 blur-3xl top-44 left-1/4 hidden md:block -z-10"></div>
    </div>
  );
};
